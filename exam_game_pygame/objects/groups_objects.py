...
from objects.interface_objects import ManaBar, HealthBar, Portal, PortalStand
...
from structures_and_parameters.structures_on_each_level import get_structures_on_level
