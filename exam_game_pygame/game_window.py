import pygame
from parameters_game import WindowParams, Color, Rooms, ActionParams, Textures
...
def main_game_loop():
    ...
    while True:
        ...
        if current_portal:
            ...
            if True:#[len(group) for group in enemies_by_room.values()].count(0) == len(enemies_by_room.values()):
                portal.update()
